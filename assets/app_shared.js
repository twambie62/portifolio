    ...
    <div class="footer-top">
      <div class="footer-left">
        ...
        <div class="footer-socials">
          ...
          <a href="https://x.com/influx_ix" aria-label="X" target="_blank" rel="noopener noreferrer" style="width:21px;height:21px;margin-top:2px" class="footer-social"><img src="${base}assets/images/footer/twitter_x.svg" alt="X"/></a>
        </div>
      </div>
